class ProjectCellView < UIView
  ...
  attr_accessor :project, :project_name, :project_details
  ...
  def configure(project)
    ...
    # Project Name
    @project_name = UILabel.alloc.initWithFrame([[20, 7],[222, 21]]) unless @project_name
    ...
    # Project Details
    @project_details = UILabel.alloc.initWithFrame([[20, 32],[222, 21]]) unless @project_details
